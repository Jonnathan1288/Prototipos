...
import com.jonnathan.gallegos.boceto.databinding.ActivityMenuPrincipalBinding;
...
public class MenuPrincipalActivity extends AppCompatActivity {
    ...
    private void asignacion(){
        imgbtnCat = (ImageButton) findViewById(R.id.imgbtnCatalogo);
    }
    ...
    private void EventosBotones(){
        imgbtnCat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intCat = new Intent(getApplicationContext(), CatalogoVehiculo.class);
